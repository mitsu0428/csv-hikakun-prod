export default {
  ...
  TEXT_COMPARE_ROW_WITHOUT_INDEX: "check how much rows which is not same with original file",
  TEXT_COMPARE_ROW_WITH_INDEX: "check how much rows which is not same with original file(and output with index number)",
  TEXT_COMPARE_VALUES: "check how much values which is not same with original file",
  DO_COMPARE_FILE: "compare csv file",
  CHECK_COMPARE_FILE: "chech compare csv file",
