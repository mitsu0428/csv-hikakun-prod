...
const About = () => {
  return (
    <div className={styles.main}>
      ...
      <div className={styles.grid}>
        <h3>【比較したいCSVファイルを準備 01】</h3>
        <p>一つ目のファイルは、マスターになるCSVファイルを準備します。</p>
        <Image src="/images/page-one.png" width={2880} height={1800} />
      </div>
      <div className={styles.grid}>
        <h3>【比較したいファイルを準備 02】</h3>
        <p>二つ目のファイルには、比較したいCSVファイルを準備します。</p>
        <Image src="/images/page-two.png" width={2880} height={1800} />
      </div>
      <div className={styles.grid}>
        <h3>【CSVファイルを操作する 01】</h3>
        <p>
          オリジナルデータを選択にマスターとなるCSVファイルを選択してデータを読み込みます。
        </p>
      </div>
      <div className={styles.grid}>
        <h3>【CSVファイルを操作する 02】</h3>
        <p>
